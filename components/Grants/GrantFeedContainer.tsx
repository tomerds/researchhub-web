...
import { getDocumentCard } from "../UnifiedDocFeed/utils/getDocumentCard";
import { isServer } from "~/config/server/isServer";
import {
  getPaginationInfoFromServerLoaded,
  useEffectFetchDocs,
} from "../UnifiedDocFeed/utils/UnifiedDocFeedUtil";
import { ReactElement, useEffect, useMemo, useRef, useState } from "react";
import { useRouter } from "next/router";
import colors, { genericCardColors } from "~/config/themes/colors";
import dynamic from "next/dynamic";
import EmptyFeedScreen from "../Home/EmptyFeedScreen";
import FeedBlurWithButton from "../UnifiedDocFeed/FeedBlurWithButton";
...
export default connect(mapStateToProps)(GrantFeedContainer);
