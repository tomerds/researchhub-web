...
interface GrantInputProps {
  originalBounty?: Bounty;
  handleGrantInputChange: ({ hasError, errorMsg, value }) => void;
  withTypeSelection?: boolean;
}

const GrantInput = ({
  handleGrantInputChange,
  ...
  const validate = ({
    ...
    if (_offeredAmount < MIN_RSC_REQUIRED) {
      ...
      _errorMsg = "Bounty amount cannot exceed 10,000,000 RSC";
  ...
  const _handleGrantInputChange = (event) => {
              ...
              <div className={css(styles.lineItemValue, styles.offeringValue)}>
                <span className={css(styles.valueNumber, styles.valueInInput)}>
                  <input
                    ...
                    type="number"
                    onChange={_handleGrantInputChange}
                    value={offeredAmount + ""}
                    pattern="\d*"
                  />
                </span>
          ...
          {!originalBounty && (
            <div className={css(infoSectionStyles.infoRow)}>
              ...
              <span className={css(infoSectionStyles.infoText)}>
                The Grant will end in 30 days or as soon as you award a proposal
              </span>
            </div>
          )}
          {!originalBounty && (
            <div className={css(infoSectionStyles.infoRow)}>
              ...
              If no proposal satisfies your request, the full grant amount
